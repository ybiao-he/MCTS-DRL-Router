...
EVAL_LENGTH = 10               	  # Number of frames to evaluate for
...
INPUT_SHAPE = (30, 30, 2)            # Size of the preprocessed input frame. With the current model architecture, anything below ~80 won't work.
