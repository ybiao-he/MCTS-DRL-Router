...
class Agent(object):
    ...
    def get_action(self, frame_number, state, evaluation=False):
        ...
        q_vals = self.DQN.predict(state.reshape((-1, self.input_shape[0], self.input_shape[1], self.input_shape[2])))[0]
    ...
    def get_intermediate_representation(self, state, layer_names=None, stack_state=False):
        ...
        # Put it all together
        return temp_model.predict(state.reshape((-1, self.input_shape[0], self.input_shape[1], self.input_shape[2])))
