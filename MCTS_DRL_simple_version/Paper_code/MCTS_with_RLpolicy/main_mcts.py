...
if __name__ == "__main__":
    ...
    board_path = os.path.join(board_path, 'board_{}.csv'.format(board_ID))
    ...
    print('Loading Model ...')
    model.load_weights(os.path.join(model_path, "model_{}/{}_best".format(board_ID, board_ID)))           # Load model if load_model flag set to true
